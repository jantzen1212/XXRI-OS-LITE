...
struct _FmMainWin
{
    ...
    GtkMenu* popup;
    /* ---- XXRI File shell (xxri-ui.c) ----
     * The XXRI design replaces the menubar/toolbar/statusbar with a
     * translucent rail and a content header; these are its widgets. */
    GtkWidget* xxri_rail;
    GtkWidget* xxri_loc_name;
    GtkWidget* xxri_loc_size;
    GtkWidget* xxri_chips;
    GList*     xxri_places;
